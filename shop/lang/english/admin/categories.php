...
define('TEXT_PRODUCTS_ADVISER', 'Adviser');
define('TEXT_PRODUCTS_ADVISER_QUESTION', 'Question');
define('TEXT_PRODUCTS_ADVISER_ANSWER', 'Answer');
...
//Products Dashboard
define('TEXT_PRODUCTS_DASHBOARD_DASHBOARD', 'Dashboard');
define('TEXT_PRODUCTS_DASHBOARD_EDITGENERALS', 'Edit Generals');
define('TEXT_PRODUCTS_DASHBOARD_EDITPICS', 'Edit Pics');
define('TEXT_PRODUCTS_DASHBOARD_EDITCOLLIS', 'Edit Collis');
define('TEXT_PRODUCTS_DASHBOARD_EDITATTRIBUTES', 'Edit Attributes');
define('TEXT_PRODUCTS_DASHBOARD_GENERATEPRICETAG', 'Generate Pricetags');
define('TEXT_PRODUCTS_DASHBOARD_EDITTEXT', 'Edit Content');
define('TEXT_PRODUCTS_DASHBOARD_EDITFILTER', 'Edit Properties');
define('TEXT_PRODUCTS_DASHBOARD_CATEGORIES', 'Categories Mapping');

//Edit Collis
define('TEXT_PRODUCTS_COLLIS_EDIT', 'Edit Collis');
define('TEXT_PRODUCTS_COLLIS_OPTION', 'Option');
define('TEXT_PRODUCTS_COLLIS_ARTICLE_NR', 'Article-Nr.');
define('TEXT_PRODUCTS_COLLIS_DELIVERY_CHOISE', 'Delivery Choise');
define('TEXT_PRODUCTS_COLLIS_WEIGHT', 'Weight');
define('TEXT_PRODUCTS_COLLIS_DELIVERY_CARDBOARD', 'Cardboard');
define('TEXT_PRODUCTS_COLLIS_PACKING_NOTE', 'Packing Note');
define('TEXT_PRODUCTS_COLLIS_CARDBOARD_NONE', 'not used');
define('TEXT_PRODUCTS_COLLIS_OUTER_CARBOARD', 'Outer Cardboard');
define('TEXT_PRODUCTS_COLLIS_OUTER_PAPER', 'Outer Paper');
define('TEXT_PRODUCTS_COLLIS_INNER_PADDING', 'Inner Padding');
define('TEXT_PRODUCTS_COLLIS_OUTER_CARBOARD', 'Au&szlig;enverpackung - Karton');
define('TEXT_PRODUCTS_COLLIS_OUTER_PAPER', 'Au&szlig;enverpackung - Papier');
define('TEXT_PRODUCTS_COLLIS_DELETE', 'Delete');
define('TEXT_PRODUCTS_COLLIS_SUCCESS', 'Processing Colli-Data success');

//Products Filter
define('TEXT_PRODUCTS_FILTER_EDIT_SUCCESS', 'Processing Filter-Data success');


define('TEXT_PRODUCTS_CONTENT_SUCCESS', 'Processing Content-Data success');

//Edit Images
define('TEXT_PRODUCTS_PICS_NOPIC', 'don\'t have a pic yet');
define('TEXT_PRODUCTS_PICS_UPLOAD', 'Upload new Pic');
define('TEXT_PRODUCTS_PICS_NODELETE', 'is not possible, no data');
define('TEXT_PRODUCTS_PICS_MAINPIC', 'Mainpicture');
define('TEXT_PRODUCTS_PICS_PIC', 'Articlepicture');


//Edit Filter
define('TEXT_PRODUCTS_FILTER_EDIT', 'Edit Filter / Properties');
