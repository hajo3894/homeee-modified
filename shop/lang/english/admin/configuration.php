...
define('NUMBER_COUNT_FAQ_DESC', 'Please set up the number of FAQ\'s');
define('NUMBER_COUNT_FAQ_TITLE', 'Number of FAQ\'s');

define('NUMBER_COUNT_COLLIS_DESC', 'Please set up the number of Collis');
define('NUMBER_COUNT_COLLIS_TITLE', 'Number of Collis');
?>