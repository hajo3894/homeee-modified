...
define('NUMBER_COUNT_FAQ_DESC', 'Bitte geben Sie die Anzahl der FAQ\'s auf Produktebene an.');
define('NUMBER_COUNT_FAQ_TITLE', 'Anzahl FAQ\'s');

define('NUMBER_COUNT_COLLIS_DESC', 'Bitte geben Sie die Anzahl der einzugebenen Collis auf Produktebene an.');
define('NUMBER_COUNT_COLLIS_TITLE', 'Anzahl Collis');
?>