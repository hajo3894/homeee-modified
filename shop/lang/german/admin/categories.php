...
define('TEXT_PRODUCTS_ADVISER', 'Ratgeber');
define('TEXT_PRODUCTS_ADVISER_QUESTION', 'Frage');
define('TEXT_PRODUCTS_ADVISER_ANSWER', 'Antwort');
...
define('TEXT_PRODUCTS_DASHBOARD_EDITGENERALS', 'Allgemeine Optionen');
define('TEXT_PRODUCTS_DASHBOARD_EDITPICS', 'Bilder bearbeiten');
define('TEXT_PRODUCTS_DASHBOARD_EDITCOLLIS', 'Collis bearbeiten');
define('TEXT_PRODUCTS_DASHBOARD_EDITATTRIBUTES', 'Attribute bearbeiten');
define('TEXT_PRODUCTS_DASHBOARD_GENERATEPRICETAG', 'Preisschilder generieren');
define('TEXT_PRODUCTS_DASHBOARD_EDITTEXT', 'Texte bearbeiten');
define('TEXT_PRODUCTS_DASHBOARD_EDITFILTER', 'Eigenschaften bearbeiten');
define('TEXT_PRODUCTS_DASHBOARD_CATEGORIES', 'Kategorie Mapping');


//Edit Collis
define('TEXT_PRODUCTS_COLLIS_EDIT', 'Colli-Daten editieren');
define('TEXT_PRODUCTS_COLLIS_OPTION', 'Option');
define('TEXT_PRODUCTS_COLLIS_ARTICLE_NR', 'Artikel-Nr.');
define('TEXT_PRODUCTS_COLLIS_DELIVERY_CHOISE', 'Versandart');
define('TEXT_PRODUCTS_COLLIS_WEIGHT', 'Gewicht');
define('TEXT_PRODUCTS_COLLIS_DELIVERY_CARDBOARD', 'Kartonage');
define('TEXT_PRODUCTS_COLLIS_PACKING_NOTE', 'Verpackungshinweis');
define('TEXT_PRODUCTS_COLLIS_CARDBOARD_NONE', 'nicht verwendet');
...
define('TEXT_PRODUCTS_COLLIS_INNER_PADDING', 'Innere Polsterung');
define('TEXT_PRODUCTS_COLLIS_DELETE', 'L&ouml;schen');
define('TEXT_PRODUCTS_COLLIS_SUCCESS', 'Colli-Daten erfolgreich verarbeitet');

//Products Filter
define('TEXT_PRODUCTS_FILTER_EDIT_SUCCESS', 'Filter Daten erfolgreich verarbeitet');


define('TEXT_PRODUCTS_CONTENT_SUCCESS', 'Texte erfolgreich verarbeitet');

//Edit Images
define('TEXT_PRODUCTS_PICS_NOPIC', 'kein Bild vorhanden');
define('TEXT_PRODUCTS_PICS_UPLOAD', 'Neues Bild hochladen');
define('TEXT_PRODUCTS_PICS_NODELETE', 'nicht m&ouml;glich, da kein Bild vorhanden');
define('TEXT_PRODUCTS_PICS_MAINPIC', 'Hauptbild');
define('TEXT_PRODUCTS_PICS_PIC', 'Artikelbild');

//Edit Filter
define('TEXT_PRODUCTS_FILTER_EDIT', 'Filter / Eigenschaften editieren');
