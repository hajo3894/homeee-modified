  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'text_search_advanced1' => 'Alternatively, you can also use the',
        'text_search_advanced2' => 'advanced search',
        'text_search_advanced3' => 'with other search parameters.',
      ),
    ),
    'upcoming_products' => 
    array (
    ...
    array (
      ...
      array (
        ...
        'text_info_post' => '!<br /><br /><strong>Step 2:</strong><br />Click the link in the confirmation e-mail we\'ll send to you. On the now opening webpage enter your new password.<br /><br /><strong>Step 3:</strong><br />Log in with your new password.',
        'text_continue' => 'Click continue to request the password change e-mail!',
        'text_email' => 'E-mail address:',
        'text_error' => '<span class="color_error_message"><strong>ATTENTION:</strong></span>This e-mail address is not registered. Please try again.',
        'text_sec_code' => 'Security code',
        'text_inp_code' => 'please enter here',
      ),
    ),
    'newsletter' => 
    array (
      ...
      array (
        ...
        'heading_personal' => 'Your data',
        'heading_text' => 'Our newsletter',
        'text_email' => 'Your e-mail address',
        'text_in' => 'subscribe to our newsletter',
        'text_zusatz' => 'I would like to receive interesting offers by e-mail. My e-mail address will not be shared with other companies. This consent to use my e-mail address for advertising purposes can be revoked at any time with effect for the future.',
    ...
    array (
      ...
      array (
        ...
        'text_note' => '<span class="color_error_message"><strong>CAUTION:</strong></span> HTML is not supported!',
        'text_bad' => 'BAD',
        'text_good' => 'VERY GOOD',
        'text_write_first_review' => 'Write the first Review!',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        'text_finished' => 'Done!',
        'text_current_address_short' => 'Your current billing address',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        'text_confirm' => 'Confirmation',
        'text_finished' => 'Done!',
        'text_current_address_short' => 'Your current shipping address',
      ),
    ),
    'ssl_check' => 
    array (
    ...
    array (
      ...
      array (
        ...
        'title_contact' => 'Your contact data',
        'text_gender' => 'Salutation:',
        'text_male' => 'Mr.',
        'text_female' => 'Ms./Mrs.',
        'text_firstname' => 'First name:',
    ...
    array (
      ...
      array (
        ...
        'text_confirm' => 'Confirmation:',
        'text_must' => '* necessary information',
        'text_account_info' => 'Your details',
        'text_password_policy' => 'A secure password should be %s characters in length and should include uppercase and lowercase letters and numbers and special characters.',
      ),
    ),
    'advanced_search' => 
    array (
    ...
    array (
      ...
      array (
        ...
        'text_contact_us' => 'How to reach us',
    ...
    array (
      ...
      array (
        ...
        'text_newsletter' => 'I would like to receive interesting offers by e-mail. My e-mail address will not be shared with other companies. This consent to use my e-mail address for advertising purposes can be revoked at any time with effect for the future.',
    ...
    array (
      'vars' => 
      array (
        'heading_confirmation' => 'Confirm your order:',
        'text_shipping_address' => 'Shipping address',
        'text_shipping_method' => 'Shipping method:',
        'title_payment_info' => 'Billing information',
        'text_payment_info' => 'Payment information',
        ...
        'text_information' => 'Please check your order details before confirmation. You can still change the adresses by clicking the <span class="color_edit_info">(Edit)</span> links next to them.<br />You can confirm your order by pressing the <strong>Buy</strong> button at the end of this order page.',
        'text_express_checkout_information' => 'Here you can save your shipping and billing information for your next order.',
        'heading_checkout_express' => 'Settings for my quick purchase',
      ),
    ),
    'checkout_payment' => 
    array (
    ...
    array (
      ...
      array (
        ...
        'text_status' => 'Order status: ',
        'label_tracking' => 'Track shipment:',
        'text_express_checkout' => 'Display/change my quick purchase settings',
      ),
    ),
    'categorie_listing' => 
    array (
    ...
    array (
      ...
      array (
        ...
        'manufacturer_model' => 'Manufacturer part number:',
        'manufacturer_more_of' => 'More products of:',
        'ean' => 'GTIN/EAN:',
        'products_category' => 'Additional Products',
        'text_discount' => 'Discount:',
        'fsk18_info' => 'This product can be purchased only after age verification.',
        'products_gift_forbidden' => 'Vouchers can not be purchased as a guest.',
        'checkout_express_activate' => 'activate my quick purchase &raquo;',
    ...
    array (
      ...
      array (
        ...
        'text_full_cart' => 'Your shopping cart contains the following products:',
        'text_products' => 'Shopping cart content',
        ...
        'text_pwd' => 'Password',
        'text_newsletter' => 'The newsletter can be canceled here or in your Account at any time.',
        'show_all' => 'more',
    ...
    array (
      ...
      array (
        ...
        'text_gift' => 'If you have received a gift voucher/coupon code, please enter it below.',
        'text_code' => 'Voucher/Coupon code:',
        'create_account' => '<strong>Attention:</strong> If you have a voucher/coupon, you can redeem it after creating a customer account.',
    ...
    array (
      ...
      array (
        ...
        'heading_text' => 'Please fill out the voucher details. If you have any questions, please check the voucher FAQ:',
    ...
    array (
      ...
      array (
        ...
        'text_confirm_download' => 'Please confirm the Download with your eMail Address.',
        'download_exceeded' => 'Your Download has expired or your Link has been canceled.',
      ),
    ),
    'xsell' => 
    array (
    ...
    array (
      'vars' => 
      array (
        'heading_text' => 'Additional Products:',
      ),
    ),
    'wishlist' => 
    array (
      ...
      array (
        ...
        'text_full_wishlist' => 'Your wishlist contains the following products:',
        'text_empty_wishlist' => 'You do not have any products in your wishlist yet.',
        'text_empty_wishlist_box' => 'Your wishlist is empty.',
      ),
    ),
    ...
    array (
      'vars' => 
      array (
        'heading_checkout_express' => 'My quick purchase',
        ...
        'text_choose_shipping_address' => 'Please select a shipping address from your address book.',
        'text_choose_payment_address' => 'Please select a billing address from your address book.',
        'text_checkout_express_info' => 'Choose your preferred shipment and payment settings. These are then, if they are permitted for use for your order with the quick purchase.',
      ),
    ),
    'filter' => 
    array (
      'vars' => 
      array (
        'text_filter_options' => 'Filter options:',
        'text_filter_reset' => 'Filter reset',
      ),
    ),
  ),
  'vars' => 
