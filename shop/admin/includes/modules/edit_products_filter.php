...
<?php echo xtc_draw_form('edit_products_text', FILENAME_CATEGORIES, 'cPath=' . $_GET['cPath'] . '&pID=' . $_GET['pID'] . '&action=update_products_filter', 'post', 'enctype="multipart/form-data"'); ?>
 ...
 <tr>
  <td>
   <article class="breadcrumbs_dashboard">
	...
	<div class="breadcrumbs_dashboard_divider"></div>
	<a class="breadcrumbs_dashboard_current"><?php echo TEXT_PRODUCTS_DASHBOARD_EDITFILTER; ?></a>
	<?php } ?>
