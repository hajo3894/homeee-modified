...
echo mainMenue(BOX_HEADING_PRODUCTS);
	...
	if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['product_filter'] == '1')) echo '<li><a
	href="' . xtc_href_link(FILENAME_PRODUCT_FILTER, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_PRODUCT_FILTER .
	'</a></li>';
...
echo mainMenue(BOX_HEADING_CONFIGURATION);
    if ($admin_access['configuration'] == '1') {
	  ...
	  echo '<li><a href="' . xtc_href_link(FILENAME_CONFIGURATION, 'gID=39', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_CONFIGURATION_39 . '</a></li>';
