...
/* -----------------------------------------------------------------------------------------
   ...
   function xtc_get_products_mo_images_export($products_id = ''){
   $mo_query = "select image_id, image_nr, image_name from " . TABLE_PRODUCTS_IMAGES_EXPORT . " where products_id = '" . $products_id ."' ORDER BY image_nr";
